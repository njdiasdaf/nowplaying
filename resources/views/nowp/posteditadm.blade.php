...
<div class="inquiry">
    <div class="inquiry-box">
        <p class="dai">投稿変更</p>
        <form action="{{ url('/posteditcompadm') }}" method="post" name="myForm" class="validationForm" novalidate>
            @csrf
            <div class="inquiryarea">
                ...
                <div class="btnarea">
                    <form action="url('/posteditcompadm')" method="post" name="myForm" class="mybtn">
                        @csrf
