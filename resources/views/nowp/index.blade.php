        ...
        <form action="{{ url('/indexpost') }}" method="post" name="myForm" class="validationForm" novalidate>
            ...
            <div class="inquiryarea">
                ...
                <div class="textarea">
                    ...
                    <input type="text" name="message" id="message" rows="5" placeholder="ひと言">
                </div>
                <p class="hissu"><span class="asterisk">*</span>の入力は必須です。</p>
                <div class="btncenter">
                    <button name="send" class="button-40" role="button">投　  稿</button>
                </div>
            </div>
        </form>
    </div>
        ...
        <form action="{{ url('/search') }}" method="GET">
            ...
            <div class="inquiryarea">
                <div class="textarea">
                    ...
                    <button name="send" class="button-40" role="button">検　索</button>
                </div>
            </div>
        </form>
    </div>
